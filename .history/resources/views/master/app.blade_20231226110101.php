...
<html lang="en">
    ...
    <body>
        ...
        <script src={{ ass }}"js/stellar.js"></script>
        <script src={{ ass }}"vendors/lightbox/simpleLightbox.min.js"></script>
        <script src={{ ass }}"vendors/nice-select/js/jquery.nice-select.min.js"></script>
        <script src={{ ass }}"vendors/isotope/imagesloaded.pkgd.min.js"></script>
        <script src={{ ass }}"vendors/isotope/isotope.pkgd.min.js"></script>
        <script src={{ ass }}"vendors/owl-carousel/owl.carousel.min.js"></script>
        <script src={{ ass }}"vendors/popup/jquery.magnific-popup.min.js"></script>
